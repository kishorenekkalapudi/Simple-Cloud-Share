<%@ Page Title="" Language="C#" MasterPageFile="~/MainHome.master" AutoEventWireup="true" CodeFile="UserRegistration.aspx.cs" Inherits="UserRegistration" %>
					...
					<tr>
						...
						<td>
                            ...
                            <asp:LinkButton ID="LinkButton1"
                                runat="server" onclick="LinkButton1_Click" CausesValidation="false">Check Availability</asp:LinkButton>
					...
					<tr>
						<td align="center">
                            <asp:Button ID="Button2" runat="server" onclick="Button2_Click" 
                                Text="Register" CausesValidation="true"/>
						</td>
