<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ApproveRequest.aspx.cs" Inherits="Admin_ApproveRequest" %>
    ...
    <asp:GridView ID="GridView1" runat="server" EnableModelValidation="True" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Approve">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton2" runat="server" CommandName="Approve" CommandArgument='<%#Bind("UserId") %>'>Approve Request</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
